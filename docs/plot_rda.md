...
rda_result <- plot_rda(response, environment, group = groups, title = "Synthetic community constrained by soil properties", style = style, output_file = "docs/images/plot-rda.png")
rda_result$plot
